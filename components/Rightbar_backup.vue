            ...
            <div class="p-3">
              ...
              <div v-if="layout !== 'horizontal'">
                ...
                <b-form-radio-group v-model="sidebarSize" stacked @input="changeSize($event)">
                  ...
                  <b-form-radio value="condensed" class="mb-1">Condensed <small>(Extra Small size)</small>
                  </b-form-radio>
              ...
              <a
                ...
                class="btn btn-danger btn-block mt-2" target="_blank"><i class="mdi mdi-basket mr-1"></i> Purchase
                Now</a>
            </div>
          </b-tab>
        </b-tabs>
