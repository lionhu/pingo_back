    ...
    axios.post(url).then(response => {
      ...
      if (response.data.result) {
        ...
        vm.visitlogs = json_data.reduce(function (result, log) {
          ...
          console.log("current result",result.total)
          console.log("current result.total + log.total",result.total + log.total)
        ...
        console.log(vm.visitlogs.labels)
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between">
            <div>
              ...
              <h3 class="my-2 py-1">
                <span data-plugin="counterup">{{ total | currency("¥") }}</span></h3>
