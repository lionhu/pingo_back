            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6 text-right">
                <b-dropdown variant="warning">
                  ...
                  <b-dropdown-item>
                    <a href="javascript:void(0)" v-b-modal.modal-delivery @click="batch_updateDeliveryInfo">Update Delivery Info</a>
                  </b-dropdown-item>
                </b-dropdown>
              </div>
            </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-lg-6">
                        <div>
                          ...
                          <div class="card p-2 mb-lg-0">
                            <div class="text-center" v-if="props.row.delivered">
                              <div class="my-2">
                              ...
                              <div class="mt-2 pt-1">
                                <p class="mb-1">
                                  ...
                                  <a :href="props.row.delivery_info.track_link">{{ props.row.delivery_info.track_no }}</a>
                                </p>
                              </div>
                            </div>
                          </div>
...
<!--                </el-table-column>-->
                ...
                >
                  <template slot-scope="scope">
                      <span class="badge "
                            :class="{'badge-soft-danger text-danger':!scope.row.paid,
