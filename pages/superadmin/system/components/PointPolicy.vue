...
methods: {
  ...
  ApplyMarginRule_all_clients(){
    let url = "/apiauth/client/superadmin_reset_margin_policy/";
          ...
          <div class="card-body">
            ...
            <div class="row mb-2">
              <div class="col-sm-6 col-xs-12">
                ...
                <div class="mt-3">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <switches v-model="point_policy.POLICIES.CLIENTADMIN" id="point_policy_client_admin" type-bold="false"
                              color="warning" class="ml-1 mb-0"></switches>
                  </div>
                  <div class="d-flex justify-content-between align-items-center">
                    <label for="point_policy_LEVEL_1">LEVEL_1</label>
                    <switches v-model="point_policy.POLICIES.LEVEL_1" id="point_policy_LEVEL_1" type-bold="false" color="warning"
                              class="ml-1 mb-0"></switches>
                  </div>
                  <div class="d-flex justify-content-between align-items-center">
                    <label for="point_policy_LEVEL_2">LEVEL_2</label>
                    <switches v-model="point_policy.POLICIES.LEVEL_2" id="point_policy_LEVEL_2" type-bold="false" color="warning"
                              class="ml-1 mb-0"></switches>
                  </div>
                  <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <switches v-model="point_policy.INTRODUCE_POINT_POLICY.APPLY" id="point_policy_INTRODUCE_POINT_POLICY_APPLY"
                              type-bold="false" color="warning" class="ml-1 mb-0"></switches>
                  </div>
                  <div class="form-horizontal" v-if="point_policy.INTRODUCE_POINT_POLICY.APPLY">
                    <b-form-group id="example text" label-cols-sm="9" label-cols-lg="9" label="INTRODUCE_POINT_POLICY.POINT"
              ...
              <div class="col-sm-6 col-xs-12">
                ...
                <b-button pill class="btn-bordered-danger"  variant="outline-danger" @click="ApplyMarginRule_all_clients">Apply to all Clients
                </b-button>
              </div>
